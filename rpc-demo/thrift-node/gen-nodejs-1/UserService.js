...
const UserServiceProcessor = exports.Processor = class UserServiceProcessor {
  ...
  process_addUser (seqid, input, output) {
    ...
    if (this._handler.addUser.length === 1) {
      Promise.resolve(this._handler.addUser.bind(this._handler)(
        args.user
      )).then(result => {
        const result_obj = new UserService_addUser_result({success: result});
  ...
  process_getUser (seqid, input, output) {
    ...
    if (this._handler.getUser.length === 1) {
      Promise.resolve(this._handler.getUser.bind(this._handler)(
        args.id
      )).then(result => {
        const result_obj = new UserService_getUser_result({success: result});
